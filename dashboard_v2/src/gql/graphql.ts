...
export type OpsHealthQueryVariables = Exact<{ [key: string]: never; }>;
...
export type OpsFailuresQueryVariables = Exact<{ [key: string]: never; }>;


export type OpsFailuresQuery = { __typename?: 'Query', failureReasonBreakdown: Array<{ __typename?: 'SeriesPoint', label: string, value: number }>, dashboardEvents: Array<{ __typename?: 'DashboardEvent', id: string, timestamp: string, eventType: string, source: string, status: string, message: string, walletAddress?: string | null }> };

export type OpsLambdasQueryVariables = Exact<{ [key: string]: never; }>;
...
export type RootCauseTraceQuery = { __typename?: 'Query', rootCauseTrace: { __typename?: 'RootCausePanel', likelyFailureCategory?: string | null, likelyFailedStage?: string | null, latestEvent?: { __typename?: 'DashboardEvent', id: string, timestamp: string, message: string, status: string } | null, firstFailureEvent?: { __typename?: 'DashboardEvent', id: string, timestamp: string, message: string } | null, relatedEvents: Array<{ __typename?: 'DashboardEvent', id: string, timestamp: string, eventType: string, message: string, status: string }> } };
...
export type SalesRevenueQuery = { __typename?: 'Query', revenueSummary: { __typename?: 'RevenueSummary', walletAddress: string, confirmedPaymentCount: number, totalAmount: string }, walletFacts: Array<{ __typename?: 'WalletFacts', walletAddress: string, totalRevenue: number, totalQuotes: number }> };
